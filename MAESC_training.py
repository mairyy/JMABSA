...
def main(rank, args):
    ...
    # make log dir if log_dir is specified
    ...
    collate_aesc = Collator(args, tokenizer,
                            bart_enabled=args.bart_enabled,
...
def parse_args():
    ...
    parser.add_argument('--trc_pretrain_file',
                        default='TRC_ckpt/pytorch_model.bin',
                        type=str,
                        help=' ')
    ...
    parser.add_argument('--bart_enabled', type=bool, default=True, help='bart or crf')
    ...
    #sim_gcn
    parser.add_argument('--sim_gcn_dropout', type=float, default=0.1, help='sim gcn dropout')
    parser.add_argument('--sim_gcn_layer_num', default=2, type=int, help='gcn layer number')
    
    parser.add_argument('--img_num', default=49, type=int, help='max img num')

    parser.add_argument('--sc_only', action='store_true', help='sc task only - for generator')
    parser.add_argument('--w_l', default=0.5, type=float, help='weight for loss crf')

    parser.add_argument('--abl_mode', default=0, type=int, help='ablation mode')
    ...
    abl_list = ['full', 'distance', 'type', 'align', 'syntactic', 'semantic', 'gate']
    ...
    if args.dataset[0][0]=='twitter15':
        args.img_path='src/data/IJCAI2019_data/twitter2015_images'
    elif args.dataset[0][0]=='twitter17':
        args.img_path='src/data/IJCAI2019_data/twitter2017_images'
    return args
